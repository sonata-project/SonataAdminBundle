            ...
            ->children()
                ...
                ->arrayNode('templates')
                    ...
                    ->children()
                        ...
                        ->scalarNode('list__action')->defaultValue('SonataAdminBundle:CRUD:list__action.html.twig')->cannotBeEmpty()->end()
                        ->scalarNode('list__action_delete')->defaultValue('SonataAdminBundle:CRUD:list__action_delete.html.twig')->cannotBeEmpty()->end()
                        ->scalarNode('list__action_edit')->defaultValue('SonataAdminBundle:CRUD:list__action_edit.html.twig')->cannotBeEmpty()->end()
                        ->scalarNode('list__action_show')->defaultValue('SonataAdminBundle:CRUD:list__action_show.html.twig')->cannotBeEmpty()->end()
