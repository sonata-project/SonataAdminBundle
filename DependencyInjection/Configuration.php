                ...
                ->arrayNode('options')
                    ...
                    ->children()
                        ...
                        ->enumNode('title_mode')
                            ...
                            ->cannotBeEmpty()
                        ->end()
                        ->scalarNode('horizontal_class_label')->defaultValue('col-sm-3')->end()
                        ->scalarNode('horizontal_class_input')->defaultValue('col-sm-9 col-md-9')->end()
                        ->scalarNode('horizontal_class_input_without_label')->defaultValue('col-sm-12 col-md-12')->end()
                    ->end()
                ->end()
                ->arrayNode('dashboard')
                    ->addDefaultsIfNotSet()
