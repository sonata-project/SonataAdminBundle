...
class AddDependencyCallsCompilerPass implements CompilerPassInterface
{
    ...
    public function fixTemplates(ContainerBuilder $container, Definition $definition, array $overwrittenTemplates = array())
    {
        ...
        $definedTemplates = array_merge(array(
            ...
            'list__action'               => 'SonataAdminBundle:CRUD:list__action.html.twig',
            'list__action_delete'        => 'SonataAdminBundle:CRUD:list__action_delete.html.twig',
            'list__action_edit'          => 'SonataAdminBundle:CRUD:list__action_edit.html.twig',
            'list__action_show'          => 'SonataAdminBundle:CRUD:list__action_show.html.twig',
