...
if (!class_exists(\Sonata\Twig\Templating\TemplateRegistryInterface::class, false)) {
    @trigger_error(
        'The '.__NAMESPACE__.'\TemplateRegistryInterface class is deprecated since version 3.x and will be removed in 4.0.'
        .' Use Sonata\Twig\Templating\TemplateRegistryInterface instead.',
        E_USER_DEPRECATED
    );
}

class_alias(
    \Sonata\Twig\Templating\TemplateRegistryInterface::class,
    __NAMESPACE__.'\TemplateRegistryInterface'
);
