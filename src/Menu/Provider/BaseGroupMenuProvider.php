...
/**
 * NEXT_MAJOR: Copy all methods to GroupMenuProvider and remove this class when dropping support for knplabs/knp-menu 2.x.
 *
 * @internal
 */
abstract class BaseGroupMenuProvider implements MenuProviderInterface
{
    ...
    public function __construct(FactoryInterface $menuFactory, Pool $pool, $checker = null)
    {
        ...
        /*
         * NEXT_MAJOR: Remove these if blocks.
