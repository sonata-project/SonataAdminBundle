            ...
            ->children()
                ...
                ->arrayNode('options')
                    ...
                    ->children()
                        ...
                        ->scalarNode('default_group')->defaultValue('default')->info("Group used for admin services if one isn't provided.")->end()
                        ->scalarNode('default_label_catalogue')->defaultValue('SonataAdminBundle')->info("Label Catalogue used for admin services if one isn't provided.")->end()
                        ->scalarNode('default_icon')->defaultValue('<i class="fa fa-folder"></i>')->info("Icon used for admin services if one isn't provided.")->end()
