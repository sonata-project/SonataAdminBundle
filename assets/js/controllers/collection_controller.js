...
export default class extends Controller {
    ...
    add(event) {
        ...
        this.dispatch('sensiolabs-admin-append-form-element', {
            prefix: '',
            detail: {
                item,
            },
        ...
        this.dispatch('sensiolabs-collection-item-added', {
            prefix: '',
            detail: {
                item,
            },
    ...
    delete(event) {
        ...
        this.dispatch('sensiolabs-collection-item-deleted', {
            prefix: '',
            detail: {
                item,
            },
        ...
        this.dispatch('sensiolabs-collection-item-deleted-successful', {
            prefix: '',
        });
    }
