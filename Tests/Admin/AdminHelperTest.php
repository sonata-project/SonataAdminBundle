...
class AdminHelperTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectdExceptionCode     0
     * @expectedExceptionMessage Could not get element id from uniquePartOfId_path_to_object_0_more_calls Failing part: calls
     */
    public function testItThrowsExceptionWhenDoesNotFindTheFullPath()
    {
        ...
        $path = $this->helper->getElementAccessPath('uniquePartOfId_path_to_object_0_more_calls', $object);
    }
